...
| 2026-08-24 | Removed DSH lifecycle menu reinstallation. The generic menu service rebuilt the application menu without the startup runtime callback, turning `Settings…` into a no-op after the initial DSH check. |
